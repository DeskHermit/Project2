function scr_init_run() {
	...
	global.notes = {
		outsidetable1 : [
			"Note",
			"The chirping is getting closer.",
			"I thought I saw something moving above the path, but every time I looked into the dark, it vanished.",
			"It does not show itself unless light hits it. Keep the flashlight ready. If you hear it nearby, shine the beam into the darkness before you move."
		],
		...
		floor1table2 : [
			"Maintenance Report",
			"Debris from the damaged ceiling has spread across the lower hallway. Broken tiles, wood scraps, and loose furniture are blocking several paths.",
			"Clear what you can, but move carefully. Some obstacles may slow you down or force you into the open.",
			"Until the area is cleaned, avoid running blindly through the ground floor."
		],

		floor1table4 : [
			"Cafeteria Notice",
			"Stop leaving open bags of chips around the ground floor.",
			"Someone keeps using them as emergency food, and now crumbs are all over the tables.",
			"If you are hurt, eat what you can find and keep moving. Just do not stand around snacking for too long.",
			"Something down here can smell food."
		],

		floor1cuboard1 : [
			"Note",
			"I went behind the table and ran as fast as I can.",
			"It splashed through the hallway like it already knew where I was.",
			"I do not think it saw me, but it heard every sound I made.",
			"If you are discovered RUN as fast as you can."
		],
		...
		floor3cuboard2 : [
			"Note",
			"The staff is no longer yours.",
			"You carried power through these halls and wasted it on tricks, light, and childish heroics. I have seen what it can do. I have seen what this Union can become with the right hand guiding it.",
			"The creatures below were not accidents. They were warnings.",
			"If you have reached this floor, then you are more persistent than I expected. But persistence is not power.",
			"Turn back, wizard.",
			"Or come take what you lost.",
			"                 - Chancellor"
		],
	};
	...
	global.content = [
		"Press WASD or arrow keys to control the character.",
		"Press F to toggle flashlight after obtaining flashlight."
	];
}